...
def train_and_validate(net: nn.Module, train_dataloader: DataLoader, test_dataloader: DataLoader, epoch_size: int = 50, lr: float = 0.001, momentum: float = 0.9):
    net = net.to(device)
    ...
    for epoch in range(epoch_size):
        ...
        duration = time() - start
        print(f"epoch {epoch}, {i+1}, duration:", duration)
